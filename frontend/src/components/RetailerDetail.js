...
class RetailerDetail extends Component {
    ...
    componentDidMount(){
        ...
        axios.get('/retailer/dashboard',{headers : { Authorization:`Bearer ${token}`}})
        .then(response => {
    ...
    onEdit(e){
       ...
       const updatedretailer={
        ...
        axios.post('/retailer/editProfile',updatedretailer,{headers : {Authorization:`Bearer ${token}`}})
        .then(res =>{
         alert("updated")
    ...
    render() {
        ...
        <h2 class="text-center">Retailer Details</h2>
        <div class="row">
            <div class="col-3"></div>
            <div class="col-6">
